...
### 멀티플레이 지원
멀티플레이 시 참여한 게스트 플레이어는 모든 플레이어가 작성한 코드를 사용할 수 있습니다.
게스트 플레이어의 권한에 상관없이 명령은 실행됩니다. 
게스트 플레이어는 채팅명령어 입력 후 채팅창이 자동으로 닫히지 않습니다. 
**사용가능 여부**: 다음 명령블록은 게스트 멀티플레이에서 제한됩니다:
- 에이전트 관련 명령
- 아이템 획득
- 블록 설치 및 파괴
- 블록 감지
