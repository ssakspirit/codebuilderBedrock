...
async function start() {
    if (await portCheck(WSPort)) {
        ...
        figlet('SteveCoding', function (err, data) {
            ...
            console.log(`Minecraft Bedrock Spawn Agent created by MinedPlumr, wow_1. for SteveCoding`);
            console.log(`마인크래프트 채팅창에 "/connect localhost:${WSPort}"를 입력하세요.`);
            console.log(`만약 연결에 실패할시 "setup.bat"를 실행하세요.`);
        });
